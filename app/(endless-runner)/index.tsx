...
// BGM remoto — mantido igual ao original do story-box.
// Se quiser bundlear pra ficar offline-first, troca por require('../../assets/sounds/space-runner-bgm.mp3').
...
export default function FantasyRunnerEndGame() {
  ...
  // === ÁUDIO ADAPTADO PRO expo-av ===
  // Original story-box usava useAudioPlayer do expo-audio (SDK 55).
  // Magic World tá em expo 54 + expo-av já no bundle, então reescrito
  // pra expo-av mantendo o mesmo comportamento (loop, restart no game over).
  useEffect(() => {
    ...
    async function loadBgm() {
      ...
      try {
        ...
        // Silencia erro de rede — jogo roda sem BGM se der ruim.
