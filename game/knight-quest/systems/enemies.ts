...
import { attachWeapon, spawn } from "../engine/loader";
...
// Re-export attachWeapon so BossSystem can import it from here (unchanged
// call site) even though it lives in the loader now.
export { attachWeapon, preloadWeapons } from "../engine/loader";
